...
const Speakers = () =>
 {
    return (
        <>
                ...
                <div className="SPEAKERCONSTAINER">

         <div className="SpeakerFlex">
                
               <div className="spk1">
                     <img  className="spk1img"    src="https://im.rediff.com/money/2014/sep/19sundar4.jpg" alt="Speaker's" /> 
                 </div>
               ...
               <div className="spk2">
                     ...
                     <button  className="SpeakerButton" >Get Your FREE TICKERS HERE</button>
               </div>
